...
@EpoxyModelClass
abstract class ConsumerGoodsEpoxyModel :
    EpoxyModelWithHolder<ConsumerGoodsEpoxyModel.ItemHolder>() {

    @EpoxyAttribute
    lateinit var item: ConsumerGoodsItemModel

    @EpoxyAttribute(EpoxyAttribute.Option.DoNotHash)
    lateinit var onClickListener: View.OnClickListener

    override fun getDefaultLayout(): Int {
        return R.layout.item_consumer_goods
    }
