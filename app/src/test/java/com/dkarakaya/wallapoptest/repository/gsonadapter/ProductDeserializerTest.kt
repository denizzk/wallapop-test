...
class ProductDeserializerTest {
    ...
    fun `GIVEN json input with car kind THEN parse the json to product with car model`() {
        ...
        Assert.assertEquals(expectedOutput, gson.fromJson(jsonInput, Product::class.java))
    }
